...
const RULES: ReadonlyArray<{
  ...
  { method: "PUT", route: /^\/v1\/projects\/[^/]+\/reporting-profile$/, permission: "project.edit" },
  { method: "GET", route: /^\/v1\/projects(?:\/[^/]+)?$/, permission: "project.view" },
  { method: "GET", route: /^\/v1\/projects\/[^/]+\/members$/, permission: "project.view" },
  { method: "POST", route: /^\/v1\/projects\/[^/]+\/members$/, permission: "users.manage" },
  { method: "PATCH", route: /^\/v1\/project-members\/[^/]+$/, permission: "users.manage" },
  { method: "DELETE", route: /^\/v1\/project-members\/[^/]+$/, permission: "users.manage" },
  { method: "PUT", route: /^\/v1\/projects\/[^/]+$/, permission: "project.edit" },
  { method: "POST", route: /^\/v1\/templates$/, permission: "template.manage" },
  { method: "POST", route: /^\/v1\/templates\/parse-file$/, permission: "template.manage" },
  ...
  { method: "POST", route: /^\/v1\/indicator-updates\/bulk$/, permission: "indicator.update" },
  { method: "POST", route: /^\/v1\/indicator-updates\/parse-sheet$/, permission: "indicator.update" },
  { method: "POST", route: /^\/v1\/indicator-updates\/[^/]+\/verify$/, permission: "indicator.verify" },
  { method: "GET", route: /^\/v1\/reporting-periods\/[^/]+\/indicators$/, permission: "project.view" },
  ...
  { method: "POST", route: /^\/v1\/reporting-periods\/[^/]+\/checklist\/bulk-resolve$/, permission: "checklist.manage" },
  { method: "POST", route: /^\/v1\/checklist\/[^/]+\/resolve$/, permission: "checklist.manage" },
  { method: "POST", route: /^\/v1\/report-sections\/[^/]+\/rewrite$/, permission: "report.edit" },
