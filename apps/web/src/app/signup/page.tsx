...
export default function SignupPage() {
  ...
  return (
    <main className="mx-auto mt-12 max-w-2xl px-6">
      ...
      <p className="mt-1 text-sm text-slate-500">Step 1 of the setup wizard</p>
      <form action={formAction} className="card mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <p className="mt-1 text-xs text-slate-500">Restricts where organization data may be written.</p>
        </div>
