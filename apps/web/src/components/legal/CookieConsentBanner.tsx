...
export function CookieConsentBanner() {
  ...
  return (
    <aside
      ...
      className="fixed inset-x-4 bottom-4 z-[100] mx-auto max-w-5xl animate-cookie-rise rounded-lg border border-cyan-300/20 bg-slate-950/95 p-4 shadow-[0_24px_80px_rgba(2,6,23,0.8)] backdrop-blur-2xl sm:p-5"
    >
      <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex w-full shrink-0 flex-col gap-2 sm:w-auto sm:flex-row">
          <button
            ...
            className="rounded-lg border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-medium text-white transition hover:border-white/25 hover:bg-white/10"
          >
            Essential only
          </button>
          <button
            ...
            className="rounded-lg bg-brand-600 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-brand-500"
          >
            Accept all
          </button>
        </div>
