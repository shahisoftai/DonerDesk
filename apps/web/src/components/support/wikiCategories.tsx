...
export const WIKI_CATEGORIES: WikiCategory[] = [
  {
    ...
    articles: [
      ...
      { title: "Understanding Activities", description: "How to capture delivery activities.", href: "/support/getting-started/understanding-activities" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "Troubleshooting Email Delivery", description: "Missing notifications or receipts.", href: "/support/troubleshooting/email-delivery" },
      { title: "Troubleshooting Payment Issues", description: "Failed donations and billing errors.", href: "/support/troubleshooting/payment-issues" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "Webhooks", description: "Receive real-time event notifications.", href: "/support/advanced-features/webhooks" },
      { title: "Automation Rules", description: "Automate repetitive tasks and notifications.", href: "/support/advanced-features/automation-rules" },
      { title: "Custom Integrations", description: "Connect DonorDesk with other tools.", href: "/support/advanced-features/custom-integrations" },
      { title: "Analytics", description: "Use advanced analytics features.", href: "/support/advanced-features/analytics" },
